...
public:
    ...
    void cmdAssignment(const ros2_unitree_legged_msgs::msg::HighCmd::SharedPtr &msg)
    {

        high_cmd = rosMsg2Cmd(msg);
    }

    void cmdAssignment(const ros2_unitree_legged_msgs::msg::LowCmd::SharedPtr &msg)
    {

        low_cmd = rosMsg2Cmd(msg);
    }

    void stateAssignment(ros2_unitree_legged_msgs::msg::LowState &low_state_ros)
    {

        low_state_ros = state2rosMsg(low_state);
    }

    void stateAssignment(ros2_unitree_legged_msgs::msg::HighState &high_state_ros)
    {
